...
<p>Check out <a href="http://scrollmagic.io">the demo page</a>, browse <a href="http://scrollmagic.io/examples/index.html">the examples</a> or read <a href="http://scrollmagic.io/docs/index.html">the documentation</a> to get started.</p>
<h2>About the Library</h2><p>ScrollMagic is a scroll interaction library.</p>
...
<h2>Availability</h2><p>To get your copy of ScrollMagic you have the choice between four options:</p>
...
<pre><code class="language-bash">git clone git://github.com/janpaepke/ScrollMagic.git
</code></pre>
...
<pre><code>http://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/ScrollMagic.min.js
</code></pre><p>All plugins and uncompressed files are also available on cdnjs.<br>For example:</p>
<pre><code>http://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/debug.addIndicators.js
http://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/debug.addIndicators.min.js
</code></pre><h2>Installation</h2><p>Include the <strong>core</strong> library in your HTML file:</p>
...
<h2>Usage</h2><p>The basic ScrollMagic design pattern is one controller, which has one or more scenes attached to it.<br>Each scene is used to define what happens when the container is scrolled to a specific offset.</p>
...
<h2>Help</h2><p>To get started, check out the available learning resources <a href="https://github.com/janpaepke/ScrollMagic/wiki">in the wiki section</a>.<br>Be sure to have a look at the <a href="http://janpaepke.github.com/ScrollMagic/examples/index.html">examples</a> to get source code pointers and make use of the <a href="http://janpaepke.github.com/ScrollMagic/docs/index.html">documentation</a> for a complete reference.</p>
<p>If you run into trouble using ScrollMagic please follow the <a href="https://github.com/janpaepke/ScrollMagic/blob/master/CONTRIBUTING.md">Troubleshooting guide</a>.<br>Should you still be unable to figure it out, feel free to post your questions in the <a href="https://github.com/janpaepke/ScrollMagic/issues">project&#39;s issues section</a>.</p>
<h2>Browser Support</h2><p>ScrollMagic aims to support all major browsers in recent versions:<br>Firefox 26+, Chrome 30+, Safari 5.1+, Opera 10+, IE 9+</p>
<h2>About the Author</h2><p>I am a digital creative based in Lausanne, Switzerland.<br>I started this project to extend my understanding of javascript (which it has).</p>
<p><a href="http://www.janpaepke.de">Check out my website</a> or <a href="http://twitter.com/janpaepke">Follow me on Twitter</a></p>
<h2>License</h2><p>ScrollMagic is dual licensed under the MIT license and GPL.<br>For more information click <a href="https://github.com/janpaepke/ScrollMagic/blob/master/LICENSE.md">here</a>.</p>
<h2>Thanks</h2><p>This library was made possible by many people who have supported it with passion, donations or advice. Special thanks go out to: <a href="https://github.com/johnpolacek">John Polacek</a>, <a href="https://github.com/greensock">Jack Doyle</a>, <a href="https://github.com/paulirish">Paul Irish</a>, <a href="https://github.com/ncerminara">Nicholas Cerminara</a>, <a href="https://github.com/krnlde">Kai Dorschner</a>, <a href="https://github.com/petr-tichy">Petr Tichy</a> and <a href="https://github.com/grayghostvisuals">Dennis Gaebel</a>.</p><script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.2/TweenMax.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/ScrollMagic.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/animation.gsap.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/jquery.ScrollMagic.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/debug.addIndicators.js"></script><script src="js/app.js"></script></body></html>